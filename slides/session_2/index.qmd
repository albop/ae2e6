...
- consumption rises permanently
    - by small amount $r$ corresponding to interests paid forever on $a_{-1}$
...
$$c_t + k_{t} + a_{t} = y_t + g_t - \frac{\omega}{2}(k_{t}-k_{t-1})^2 +(1-\delta) k_{t-1} + (1+r^{\star}+\pi(a_{t-1}))a_{t-1}$$
